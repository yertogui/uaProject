...
/* uaUCRuaProject2Bundle:uaGender:ua_update_gender_page.html.twig */
class __TwigTemplate_7379e7c91442450c54601c89d242e0efd80e47dd4c092d28eeee795683a5fc53 extends Twig_Template
{
 ...
 <h2>Update Gender</h2>
    ...
    <form name=\"form1\" id=\"form1\" action=\"";
        // line 10
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ua_ucr_ua_project2_update_gender", array("code" => $this->getAttribute((isset($context["allGenders"]) ? $context["allGenders"] : $this->getContext($context, "allGenders")), "getCode", array(), "method"))), "html", null, true);
        echo " \" method=\"post\">
        <table>
            <tr>
                <td> Name: </td>
                <td> 
                    <input type =\"text\" name =\"txtGender\" id=\"txtGender\"value=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["allGenders"]) ? $context["allGenders"] : $this->getContext($context, "allGenders")), "getName", array(), "method"), "html", null, true);
        echo "\"> </input>
                <div id=\"msgErrorActorLast\" style=\"color: red\"  >*</div>                                   
                </td> 
              ...
              <tr>
                <td>
                   ...
                   <input type=\"submit\"value=\"Update Gender\" name=\"btnInsertG\" id=\"btnInsertG\"/> </input>                                    
                </td>    
            </tr>
            </table>
        </form>
...
";
    ...
    {
        return "uaUCRuaProject2Bundle:uaGender:ua_update_gender_page.html.twig";
    }
