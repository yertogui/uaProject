...
/* uaUCRuaProject2Bundle:uaGender:ua_delete_gender_page.html.twig */
class __TwigTemplate_31ab34a6160b0cbf70a5665924a6c97654ffc47f219ae90bcb203ced2f735488 extends Twig_Template
{
    ...
    {
        // line 7
        echo "<h1> Are you sure to remove this gender?</h1>
<div class=\"section group\"><form name=\"form1\" id=\"form1\" action=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ua_ucr_ua_project2_delete_gender", array("codGender" => $this->getAttribute((isset($context["allGenders"]) ? $context["allGenders"] : $this->getContext($context, "allGenders")), "getCode", array(), "method"))), "html", null, true);
        echo " \" method=\"post\" >
        ...
        echo "</h5>
            ...
            <input type=\"submit\" value=\"Delete Gender\" name=\"btnDeleteG\" id=\"btnDeleteG\"/> </input>                                    
...
";
    ...
    {
        return "uaUCRuaProject2Bundle:uaGender:ua_delete_gender_page.html.twig";
    }
